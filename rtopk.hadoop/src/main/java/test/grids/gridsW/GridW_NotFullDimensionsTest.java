...
public class GridW_NotFullDimensionsTest {
    
    @Test
	public void getRelativeReducerNumber_D1_Test() {
	 ...
	 * @return the grid
	 */
    private GridW_NotFullDimensions createGrid(){
		Cell_W cell1 = new Cell_W(0,2);
		cell1.setLowerBound(new float[]{0.25f,0.75f});
		cell1.setUpperBound(new float[]{0.0f,1.0f});
		Cell_W cell2 = new Cell_W(1,2);
		cell2.setLowerBound(new float[]{0.5f,0.5f});
		cell2.setUpperBound(new float[]{0.25f,0.75f});
		Cell_W cell3 = new Cell_W(2,2);
		cell3.setLowerBound(new float[]{0.75f,0.25f});
		cell3.setUpperBound(new float[]{0.5f,0.5f});
		Cell_W cell4 = new Cell_W(3,2);
		cell4.setLowerBound(new float[]{1.0f,0.0f});
		cell4.setUpperBound(new float[]{0.75f,0.25f});
		
		GridW_NotFullDimensions grid;
		grid = new GridW_NotFullDimensions();
		grid.add(cell1);
		grid.add(cell2);
		grid.add(cell3);
		grid.add(cell4);
