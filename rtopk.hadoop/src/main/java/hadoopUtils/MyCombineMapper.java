...
import algorithms.cutS.combinedMapper.AlgorithmCutS;
import algorithms.cutS.combinedMapper.AlgorithmS_CombineNotRealBoundsAndRLists;
import algorithms.cutS.combinedMapper.AlgorithmS_RealBounds;
import algorithms.cutS.combinedMapper.AlgorithmS_Rlists;
import algorithms.cutS.combinedMapper.AlgorithmsS_NotRealBounds;

public class MyCombineMapper extends Mapper<LongWritable, DocumentLine, MyKey, MyItem> {
	...
	@Override
	protected void setup(Mapper<LongWritable, DocumentLine, MyKey, MyItem>.Context context) throws IOException, InterruptedException {
		super.setup(context);
	...
	public void map(LongWritable key, DocumentLine value, Context context) throws IOException, InterruptedException {
	...
	// https://hadoop.apache.org/docs/current/api/org/apache/hadoop/mapreduce/Mapper.html
	@Override
	protected void cleanup(Mapper<LongWritable, DocumentLine, MyKey, MyItem>.Context context) throws IOException, InterruptedException {
